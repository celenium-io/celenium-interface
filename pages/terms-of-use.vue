	...
	<Flex direction="column" align="start" gap="24" :class="$style.wrapper" wide>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<Text :class="$style.section_paragraph">You may terminate your account and subscription at any time by providing us with 30 days' prior notice. This can be done by following the instructions provided on the website or by contacting our support team at <a href="mailto:celenium@pklabs.me">celenium@pklabs.me</a>. Upon termination, you will lose access to all Services provided through the Website, and any data associated with your account may be deleted.</Text>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<Text :class="$style.section_paragraph">For support, contact us at <a href="mailto:celenium@pklabs.me">celenium@pklabs.me</a>.</Text>
			</Flex>
		</Flex>
	</Flex>
</template>
