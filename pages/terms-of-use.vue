		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<ul :class="$style.letter_list">
					...
					<li>are not participating from, or are a national or resident of, any of the countries embargoed or restricted by, including without limitation, the Monetary Authority of Singapore (MAS) or under the United Nations Act (Chapter 339) of Singapore (“Prohibited Jurisdictions”); and</li>
				...
				<Text :class="$style.section_paragraph">“Sanctions” means economic or financial sanctions or trade embargoes imposed, administered or enforced from time to time by Singapore and any governmental body of any other relevant jurisdiction.</Text>
			</Flex>
		</Flex>
