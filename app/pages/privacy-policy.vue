...
<template>
	<Flex direction="column" align="start" gap="24" :class="$style.wrapper" wide>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					(“<b>Company</b>”, “<b>we</b>”, or “<b>us</b>”) is the operator of the Website
					<a href="https://celenium.io" :class="$style.link">https://celenium.io</a> (the “<b>Website</b>”).</Text
				>
				...
				<Text :class="$style.section_paragraph"
					...
					or provide a reference to this Privacy Policy or additional privacy notices.</Text
				>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<Text :class="$style.section_paragraph"
					...
					<a href="mailto:celenium@baking-bad.org" :class="$style.link">celenium@baking-bad.org</a> in writing by e-mail or letter
					to the following address: BB Strategy Pte. Ltd, 165b Telok Ayer St, 068617 Singapore</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					>We process various categories of personal data about you. The main categories of personal data are the following:</Text
				>
			</Flex>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					...
					<Text :class="$style.section_paragraph"
						...
						shall ensure the functionality and security of our services.</Text
					>
					<Text :class="$style.section_paragraph"
						...
						or the performance of a contract.</Text
					>
					<Text :class="$style.section_paragraph"
					...
					<Text :class="$style.section_paragraph"
						...
						<a href="http://www.allaboutcookies.org" target="_blank" :class="$style.link">http://www.allaboutcookies.org</a> and
						section 4.</Text
					>
				</Flex>
			</Flex>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						...
						personal data to identify you.</Text
					>
					<Text :class="$style.section_paragraph"
						>We use this data, which you may give voluntarily, only in order to answer your contact question / request in the
						best possible manner.</Text
					>
					<Text :class="$style.section_paragraph"
						>We generally keep your communication data for <u>12 months</u> from the last exchange between us. This period may
						be longer where required for evidentiary purposes, to comply with legal or contractual requirements. E-mails in
						personal mailboxes, written correspondence and chats are generally kept for <u>2 years</u>.</Text
					>
				</Flex>
			</Flex>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						...
						for example, your role and function.</Text
					>
					<Text :class="$style.section_paragraph"
					...
					>
					<Text :class="$style.section_paragraph"
						>We generally keep master data for <u>2 years</u> from the last exchange between us or from the end of the contract.
						...
						than <u>2 years</u> from the last contact.</Text
					>
					<Text :class="$style.section_paragraph"
						...
						example contact persons, recipients of services, advertising recipients or representatives.</Text
					>
					<Text :class="$style.section_paragraph"
						>Master data is not collected comprehensively for all contacts. The data collected in an individual case depends
						mostly on the purpose of the processing activity.</Text
					>
				</Flex>
			</Flex>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						...
						this data for <u>2 years</u> from the last contract activity or from the end of the contract. This period may be
						longer where necessary for evidentiary purposes, to comply with legal or contractual requirements.</Text
					>
				</Flex>
			</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					transmitted between the server and your system and enables a specific device or browser to be recognised.<br />You can
					set your browser so that it automatically rejects, accepts or deletes cookies. You can also deactivate or delete cookies
					in individual cases. You can find out how to manage cookies in your browser in your browser's help menu.</Text
				>
				<Text :class="$style.section_paragraph"
				...
				<Text :class="$style.section_paragraph"
					...
					please refer to their respective privacy policies.</Text
				>
				<Text :class="$style.section_paragraph"
					...
					statistics and to place adverts.</Text
				>
				<Text :class="$style.section_paragraph"
				...
				<ul>
					<li>
						<Flex direction="column">
							...
							<Text :class="$style.section_paragraph"
								>Privacy policy:
								<a href="https://support.google.com/analytics/answer/6004245" target="_blank" :class="$style.link"
					...
					<li>
						<Flex direction="column">
							...
							<Text :class="$style.section_paragraph"
								>Privacy policy:
								<a href="https://developers.google.com/fonts/faq/privacy" target="_blank" :class="$style.link"
					...
					<li>
						<Flex direction="column">
							...
							<Text :class="$style.section_paragraph"
								>Privacy policy:
								<a href="https://www.cloudflare.com/privacypolicy" target="_blank" :class="$style.link"
					...
					<li>
						<Flex direction="column">
							...
							<Text :class="$style.section_paragraph"
								>Privacy policy:
								<a href="https://amplitude.com/privacy" target="_blank" :class="$style.link"
					...
					<li>
						<Flex direction="column">
							...
							<Text :class="$style.section_paragraph"
								>Privacy policy:
								<a href="https://wallet.keplr.app/privacy-policy.html" target="_blank" :class="$style.link"
									>https://wallet.keplr.app/privacy-policy.html</a
								></Text
							>
						</Flex>
					</li>
					<li>
						<Flex direction="column">
							...
							<Text :class="$style.section_paragraph"
								>Privacy policy:
								<a href="https://www.leapwallet.io/legal/privacy" target="_blank" :class="$style.link"
									>https://www.leapwallet.io/legal/privacy</a
								></Text
							>
						</Flex>
					</li>
				...
				<Text :class="$style.section_paragraph"
					...
					found in the sections 6 and 7.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					not, however, affect the lawfulness of the processing based on the consent prior to withdrawal.</Text
				>
				<Text :class="$style.section_paragraph"
					...
					Company, including its operations, safely and efficiently.</Text
				>
				<Text :class="$style.section_paragraph"
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					in particular to the following categories of recipients:</Text
				>

				<ul>
					<li>
						<b>Service Providers:</b> We work with service providers in Singapore and abroad who process your data on our behalf
						...
						a contractual relationship.<br />In each case, we disclose to these providers the data they require for their
					...
					<li>
						<b>Contractual partners including customers:</b> This refers to customers (for example service recipients) and our
					...
					<li>
						<b>Authorities:</b> We may disclose personal data to agencies, courts and other authorities in Singapore and abroad
					...
					<li>
						<b>Other persons:</b> This means other cases where interactions with third parties follows from the purposes set out
				...
				<Text :class="$style.section_paragraph"
					...
					protection rights, please contact these third parties directly.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					>As referred in Section 6, we disclose data to other parties. These are not all located in Singapore.</Text
				>
				<Text :class="$style.section_paragraph"
					...
					<a href="https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj" target="_blank" :class="$style.link"
						>https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj</a
					>, unless the recipient is subject to a legally accepted set of rules to ensure data protection and unless we cannot
					...
					been made available generally by you and you have not objected against the processing.</Text
				>
				<Text :class="$style.section_paragraph"
					>Please note that data exchanged via the internet is often routed through third countries. Your data may therefore be
					sent abroad even if the sender and recipient are in the same country.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					storage or processing period has expired as part of our usual processes.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					being improved in line with technical developments.</Text
				>
				<Text :class="$style.section_paragraph"
				...
				<Text :class="$style.section_paragraph"
					...
					Company assumes no responsibility and liability for these.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						...
						you may, at any time, contact the responsible person as stated in Section 1 of this Privacy Policy.</Text
					>
				</Flex>
			</Flex>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						...
						this information. Furthermore, you will have access to the following information:</Text
					>
					...
					<Text :class="$style.section_paragraph"
						...
						in Section 1 of this Privacy Policy.</Text
					>
				</Flex>
			</Flex>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						...
						have the obligation to erase personal data without undue delay where one of the following grounds applies:</Text
					>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						...
						transfer it to another controller.</Text
					>
				</Flex>
			</Flex>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						>You have the right to obtain from the Company restriction of processing where one of the following applies:</Text
					>
					...
					<Text :class="$style.section_paragraph"
						...
						person will arrange the restriction of the processing.</Text
					>
				</Flex>
			</Flex>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						...
						profiling based on these provisions.</Text
					>
					<Text :class="$style.section_paragraph"
						...
						contact the responsible person.</Text
					>
				</Flex>
			</Flex>
			...
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					<Text :class="$style.section_paragraph"
						...
						contact the responsible person as stated in Section 1.</Text
					>
				</Flex>
			</Flex>
			<Flex :class="[$style.section, $style.sub_section, $style.section_content]">
				...
				<Flex :class="[$style.section, $style.section_content]">
					...
					<Text :class="$style.section_paragraph"
						...
						identification is not possible otherwise).</Text
					>
					<Text :class="$style.section_paragraph"
						...
						on our key partners and service providers in Section 6.</Text
					>
					<Text :class="$style.section_paragraph"
						>Please note that conditions, exceptions or restrictions apply to these rights under applicable data protection law
						(for example to protect third parties or trade secrets). We will inform you accordingly where applicable.</Text
					>
					<Text :class="$style.section_paragraph"
						...
						with the competent data protection supervisory authority in your country.</Text
					>
				</Flex>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					the purpose of deleting that information.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					policies, we will note which Sections have been updated.</Text
				>
			</Flex>
		</Flex>
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<ul>
					...
					<li>
						...
						<a href="https://sso.agc.gov.sg/Act/PDPA2012" target="_blank" :class="$style.link"
							>https://sso.agc.gov.sg/Act/PDPA2012</a
						>
					</li>
				</ul>
				...
				<Text :class="$style.section_paragraph"
					...
					<a href="mailto:celenium@baking-bad.org" :class="$style.link">celenium@baking-bad.org</a>.</Text
				>
			</Flex>
		</Flex>
	</Flex>
