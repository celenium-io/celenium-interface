...
import {
	fetchRollupBySlug,
	fetchRollupOrgBySlug,
	fetchRollupOrgCommitsBySlug,
	fetchRollupOrgReposBySlug,
	fetchRollupRankingBySlug,
} from "~/services/api/rollup.js"
...
/** Services */
import { comma, isMainnet, roundTo, sortArrayOfObjects } from "~/services/utils/index.js"
import { getMetricCategory, getRankCategory } from "~/services/constants/rollups.js"
						...
						<Flex direction="column" gap="12" :class="$style.rank_description">
							<Flex direction="column" gap="12" :style="{ flex: 1 }">
								...
								<Flex direction="column" gap="6">
									...
									>
										{{ `${roundTo(rollup?.ranking?.rank / 10, 0)} ${rollup?.ranking?.category?.name}` }}
									</Text>
