<script setup>
/** API */
import { executeFaucet, fetchBalance } from "~/services/api/faucet.js"

/** Services */
import { capitilize, comma, getNetworkName, splitAddress, tia } from "~/services/utils/index.js"
import { faucetAddress, getServerURL, useServerURL } from "~/services/config.js"
				...
				<Flex direction="column" gap="32">
					<Flex direction="column" gap="8">
						...
						<Flex id="2" :class="[$style.answer, openedQuestion === 2 && $style.answer_extended]">
							<Text size="13" weight="500" color="tertiary" height="160">
								You can request testnet tokens by entering your Celestia testnet address, and clicking the "Receive TIA"
								button. Tokens will be sent to your wallet within a few moments.
							</Text>
						</Flex>
