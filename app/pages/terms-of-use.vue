...
<template>
	<Flex direction="column" align="start" gap="24" :class="$style.wrapper" wide>
		...
		<Flex :class="$style.section">
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					Terms of Use (“<b>Terms</b>”), together with any documents which are expressly incorporated by reference govern your
					access to and use of <a href="https://celenium.io" :class="$style.link">https://celenium.io</a> (hereinafter the
					"<b>Website</b>”).</Text
				>
				<Text :class="$style.section_paragraph"
					...
					under this <a href="https://celenium.io/privacy-policy" :class="$style.link">https://celenium.io/privacy-policy</a>. If
					you are not in agreement with these Terms, you may not access our Website.</Text
				>
				<Text :class="$style.section_paragraph"
					...
					It is your responsibility to check these Terms periodically for changes.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					>Through the Website, we offer various services (the “<b>Services</b>”), including the following:</Text
				>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<Text :class="$style.section_paragraph"
					...
					applicable law or regulation.</Text
				>
				<Text :class="$style.section_paragraph"
					...
					end of each session if you access the Services from a shared or public device.</Text
				>
				<Text :class="$style.section_paragraph"
					>We will not be liable for any loss or damage arising from your failure to comply with these security obligations. You
					are solely responsible for all activities that occur under your account, whether or not authorized by you.</Text
				>
				<Text :class="$style.section_paragraph"
					>You agree to use your account solely for your own purposes and not to impersonate any other person or entity, or
					falsely state or otherwise misrepresent your affiliation with any person or entity.</Text
				>
				<Text :class="$style.section_paragraph"
					...
					inaccurate, false, or misleading.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					>Some of the Services may be subject to fees (the “<b>Fees</b>”). Payments of the Fees are processed through a
					third-party payment service provider (i.e. Stripe).</Text
				>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					action by any person.</Text
				>
				<Text :class="$style.section_paragraph"
					>The Website may contain links to websites and content that is controlled or operated by third parties (“<b
						>Third Party Links</b
					>”). The Company is providing these Third Party Links to you only for convenience and the inclusion of any Third Party
					Links on the Website does not imply any endorsement by the Company of the Third Party Links and/or their operators. The
					Company is not responsible for any and all content contained in or associated with the Third Party Links.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					Immediately notify us as set forth in these Terms before any of the following occur:</Text
				>
				...
				<Text :class="$style.section_paragraph"
					...
					activities, including but not limited to the following list of prohibited activities:</Text
				>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					requirements of such authorization.</Text
				>
				<Text :class="$style.section_paragraph"
					...
					compliance with local laws.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					>You represent, warrant and covenant to us that you have not been, are not and will not be:</Text
				>
				...
				<Text :class="$style.section_paragraph"
					...
					Laws and Sanctions, applicable to you.</Text
				>
				<Text :class="$style.section_paragraph"
					>For the purposes of this clause, the following words shall have the following meanings:</Text
				>
				<Text :class="$style.section_paragraph"
				...
				<Text :class="$style.section_paragraph"
					...
					supplemented or substituted from time to time.</Text
				>
				<Text :class="$style.section_paragraph"
					>“Sanctions” means economic or financial sanctions or trade embargoes imposed, administered or enforced from time to
					time by Singapore and any governmental body of any other relevant jurisdiction.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<Text :class="$style.section_paragraph"
					...
					purpose, applicants need prior written permission from the Company.</Text
				>
				<Text :class="$style.section_paragraph"
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					or any services or items obtained through the Website will otherwise meet your needs or expectations.</Text
				>
				<Text :class="$style.section_paragraph"
				...
				<Text :class="$style.section_paragraph"
					...
					and output, and for maintaining a means external to our site for any reconstruction of any lost data.</Text
				>
				<Text :class="$style.section_paragraph"
					...
					any material posted on it, or on any website linked to it.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					not allow limitations of liability, so the foregoing limitation may not apply to you.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					Terms by you or your participation in the Website and/or the Services.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<Text :class="$style.section_paragraph"
					...
					<a href="mailto:celenium@baking-bad.org" :class="$style.link">celenium@baking-bad.org</a>. Upon termination, you will
				...
				<Text :class="$style.section_paragraph"
					...
					not limited to, provisions regarding ownership, indemnity, disclaimers, and limitations of liability.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					hereunder to any third party.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					right or provision under these Terms shall not constitute a waiver of such right or provision.</Text
				>
				<Text :class="$style.section_paragraph"
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					subject matter or formation.</Text
				>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph"
					...
					Terms. These Terms merge all previous discussions and negotiations between us and you and supersede them.</Text
				>
				<Text :class="$style.section_paragraph"
