...
/** Services */
import { isValidQueryParam, roundTo } from "~/services/utils/index.js"

/** API */
import { fetchValidatorsUpgrades } from "~/services/api/validator.js"
										...
										<Tooltip>
											...
											<template #content>
												<Text size="12" weight="600" color="primary">
													<Text :color="getVotingShare(u) > 83.3 ? 'brand' : 'tertiary'">
														{{ roundTo(getVotingShare(u), 2) }}%
													</Text>
													/ 83.3%
												</Text>
											</template>
				...
				<Flex v-else-if="!isLoading" direction="column" gap="20" align="center" :class="$style.empty">
					<Flex direction="column" gap="8" align="center">
						...
						<Text size="12" weight="400" color="tertiary">
							{{ `There are no ${page !== 1 ? "more" : ""} upgrades for this Celestia network` }}
						</Text>
					</Flex>
				</Flex>
			</Flex>
