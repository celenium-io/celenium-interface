...
import { Dropdown, DropdownItem, DropdownTitle, DropdownDivider } from "~/components/ui/Dropdown/index.js"
...
/** Utils */
import { getNetworkName } from "~/services/utils/general.js"
import { StatusMap } from "~/services/constants/node.js"
import { isMainnet, isMobile } from "~/services/utils/index.js"
import { nodeStatsURL } from "~/services/config.js"
...
<template>
	<Flex direction="column" gap="32" justify="between" :class="[$style.wrapper, appStore.showSidebar && $style.show]">
		...
		<Flex direction="column" gap="16" style="margin-right: 20px">
			...
			<Dropdown v-if="settings.sidebar.footer.showNetworkSelector" position="end" fullWidth :disabled="isSelfhosted()">
