...
/** Services */
import { capitilize, comma, numToPercent, shortHex, splitAddress } from "~/services/utils/index.js"
...
import {
	...
	fetchSignals,
} from "~/services/api/validator.js"
import { fetchVotesByAddressHash } from "~/services/api/address.js"
