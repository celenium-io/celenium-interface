...
/** Services */
import { shareOfTotalString, splitAddress } from "~/services/utils/index.js"
			...
			<tbody>
				<tr v-for="d in delegators">
						...
						<NuxtLink :to="`/address/${d.delegator.hash}`">
							<Flex align="center" direction="row" gap="12">
								...
								<Tooltip v-if="validator.delegator.hash === d.delegator.hash" position="start" delay="500">
									...
									<template #content>
										<Text size="13" weight="600" color="secondary"> Self delegation </Text>
									</template>
								</Tooltip>
							</Flex>
						</NuxtLink>
					...
					<td>
						<NuxtLink :to="`/address/${d.delegator.hash}`">
							<AmountInCurrency
								:amount="{ value: d.amount, decimal: 2 }"
