					...
					<Flex justify="center" direction="column" gap="10" wide>
						<Flex align="center" justify="between" wide>
							...
							<Text size="12" weight="600" color="primary">
								<Text :color="upgrade.votedShare > 83.3 ? 'brand' : 'tertiary'">
						...
						<Flex align="center" justify="between">
							<Flex align="center" gap="6">
								...
								<Tooltip>
									...
									<template #content> When the first signal was sent. </template>
								</Tooltip>
							</Flex>
						...
						<Flex v-if="upgrade.applied_at_level" align="center" justify="between">
							<Flex align="center" gap="6">
								...
								<Tooltip>
									...
									<template #content> When the network was updated to a new version. </template>
								</Tooltip>
							</Flex>
						...
						<Flex v-if="upgrade.signer" align="center" justify="between">
							<Flex align="center" gap="6">
								...
								<Tooltip>
									...
									<template #content> Address that sent a successful upgrade transaction. </template>
								</Tooltip>
							</Flex>
