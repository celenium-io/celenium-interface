...
/** Services */
import { capitilize, comma, formatBytes, hexToRgba, isMainnet, roundTo, truncateDecimalPart } from "~/services/utils/index.js"
import { exportToCSV } from "~/services/utils/export.js"
import { getRankCategory } from "~/services/constants/rollups.js"
import { rollupRankingServiceURL } from "~/services/config.js"

/** API */
import { fetchRollupBlobs, fetchRollupExportData, fetchRollupNamespaces, fetchRollupRankingBySlug } from "~/services/api/rollup.js"
		...
		<Flex align="center" justify="between" :class="$style.header">
			...
			<Flex align="center" gap="12">
				...
				<Button
					...
					:link="`/blobstream?network=${rollup.settled_on?.toLowerCase()}&page=1`"
					type="secondary"
					size="mini"
				>
