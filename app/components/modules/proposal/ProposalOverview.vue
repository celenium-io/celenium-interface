...
/** Services */
import { comma, splitAddress } from "~/services/utils/index.js"
import { getProposalIcon, getProposalIconColor, getProposalType, getProposalTypeIcon } from "~/services/utils/states.js"

/** API */
import { fetchProposalVotes } from "~/services/api/proposal.js"
		...
		<Flex gap="4" :class="$style.content">
			<Flex direction="column" :class="$style.data">
				...
				<Flex direction="column" gap="24" :class="$style.main">
					...
					<Flex
						v-if="['rejected', 'removed', 'failed'].includes(proposal.status)"
						direction="column"
						gap="10"
