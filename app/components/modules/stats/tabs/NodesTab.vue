...
/** Services */
import { capitilize, sortArrayOfObjects } from "~/services/utils/index.js"

/** API */
import { fetchNodeStats, fetchNodeVersionStats } from "~/services/api/stats.js"
	...
	<Flex align="center" direction="column" gap="16" wide :class="$style.wrapper">
		<Flex align="start" direction="column" gap="32" wide :class="$style.section">
			...
			<Flex v-if="!isLoading" align="center" justify="end" wide>
				<Text size="12" color="tertiary" justify="start"
