...
/** Services */
import { abbreviate, comma, formatBytes, roundTo, tia, truncateDecimalPart } from "~/services/utils/index.js"

/** API */
import { fetchSeries, fetchSeriesCumulative, fetchTVL, fetchTVS } from "~/services/api/stats.js"
...
<template>
	<Flex direction="column" justify="between" gap="16" wide :class="$style.wrapper">
		<NuxtLink
			:to="`/stats/${series.page}${series.aggregate ? '?aggregate=' + series.aggregate : ''}`"
			:class="[$style.header, !series.page && $style.disabled]"
		>
			<Flex align="center" direction="column" gap="16" :class="$style.title">
				<Flex align="center" justify="between" wide>
					<Flex align="center" gap="10" justify="start">
						...
						<DiffChip :value="diff" :invert="series.name === 'block_time'" :tooltip="diffTooltip" />
					</Flex>
