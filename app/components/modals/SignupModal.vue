...
const username = ref()
const usernameValidation = z.string().min(3, "Minimum 3 characters long").max(150, "Maximum 150 characters long").trim()
	...
	<Modal :show="show" @onClose="emit('onClose')" width="400" disable-trap>
		<Flex align="center" direction="column" gap="20">
			...
			<Flex wide direction="column" gap="8">
				...
				<Text size="12" weight="500" color="tertiary"> 150 characters or fewer. Letters, digits and @/./+/-/_ only. </Text>
			</Flex>
			...
			<Flex wide direction="column" gap="8">
				...
				<Text size="12" weight="500" color="tertiary"> Enter a valid email address. </Text>
			</Flex>

			<Flex wide direction="column" gap="8">
				<Input v-model="password" @click="passwordError = null" type="password" label="Password" placeholder="Your password" wide>
			...
			<Flex wide direction="column" gap="8">
				<Input
					...
					@click="repeatPasswordError = null"
					type="password"
				...
				<Text size="12" weight="500" color="tertiary"> Enter the same password as before, for verification. </Text>
			</Flex>
			...
			<Flex wide align="center" justify="center" gap="4">
				...
				<Text @click="handleLogin" size="12" weight="600" color="blue" align="center" class="clickable"> Login </Text>
			</Flex>
		</Flex>
	</Modal>
</template>
