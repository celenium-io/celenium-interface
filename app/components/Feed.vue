...
/** Services */
import { abbreviate, capitilize, comma, formatBytes, isMainnet, roundTo } from "~/services/utils/index.js"
import { getRankCategory } from "~/services/constants/rollups.js"
import { quoteServiceURL, rollupRankingServiceURL } from "~/services/config.js"

/** UI */
import Tooltip from "~/components/ui/Tooltip.vue"

/** API */
import { fetchRollupsRanking } from "~/services/api/rollup.js"
import { fetchPriceSeries, fetchSummary, fetchTVS } from "~/services/api/stats.js"
							...
							<template #content>
								<Flex direction="column" gap="8">
									<Flex align="center" justify="between" gap="8">
										...
										<Text size="12" weight="600" :color="topRollup?.category?.color">
											{{ topRollup?.category?.name }}
										</Text>
									</Flex>
									<Flex align="center" justify="between" gap="8">
