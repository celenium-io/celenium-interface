...
/** Services */
import { buildBarChart, buildLineChart } from "~/services/utils/entityCharts.js"
...
const { metric, title, tooltipLabel, yAxisFormatter, tooltipValueFormatter, unit } = props.seriesConfig || {}
